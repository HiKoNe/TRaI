...
namespace TRaI.UIs.UIElements
{
    public class UIItemIngredient : UIElement
    {
        ...
        public void AddItem(ItemIngredient itemIngredient)
        {
            ...
            Item.Add(new(itemIngredient.ItemID, flag ? itemIngredient.StackMin : 1));
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            if (Count > 0 && IsMouseHovering)
            {
                ...
                Main.HoverItem = Item[current].Clone();
                if (Info[current].Length > 0)
                    TRaIGlobalItems.AddTooltip = new(TRaI.Instance, "AddTooltip", Info[current]) { overrideColor = Color.Gold };
