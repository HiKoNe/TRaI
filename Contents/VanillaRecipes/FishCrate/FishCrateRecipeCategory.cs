...
{
    public class FishCrateRecipeCategory : RecipeCategory
    {
        public override Asset<Texture2D> TextureIcon => TextureAssets.Item[ItemID.WoodenCrate];
        public override LocalizedText Name => Language.GetText("Mods.TRaI.FishCrates");
        ...
        public override void InitRecipes()
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                Recipes.Add(new FishCrateRecipeElement(list[i]));
            }
        }
